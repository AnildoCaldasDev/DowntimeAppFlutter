...
void main() {
  HttpOverrides.global = new HttpOverridesToInvalidCertificate();
  runApp(MyApp());
}

//Method created to enable make calls with https certificate invalids or http
class HttpOverridesToInvalidCertificate extends HttpOverrides {
  @override
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        elevation: 0.0,
        title: Text("App Flutter Developer",
