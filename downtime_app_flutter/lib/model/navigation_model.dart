...
class NavigationModel {
  String title;
  IconData icon;
  //TODO: manipulate router with the enum values and not strings statics
  String router; 
...
List<NavigationModel> navigationItems = [
  ...
  NavigationModel(title: "Access Control", icon: Icons.account_box, router: "accesscontrol"),
   NavigationModel(title: "Covid19 - Quiz", icon: Icons.format_list_numbered, router: "covid19"),  
  NavigationModel(title: "Dashboards", icon: Icons.insert_chart, router: "dashboards"),
  NavigationModel(title: "Downtimes", icon: Icons.av_timer, router: "downtimes"),
  NavigationModel(title: "Foxzilla", icon: Icons.perm_data_setting, router: "foxzilla"),
  NavigationModel(title: "Inventory", icon: Icons.domain, router: "inventory"),  
  NavigationModel(title: "Master Data", icon: Icons.data_usage, router: "masterdata"),
  NavigationModel(title: "Spare Parts", icon: Icons.settings_input_component, router: "spareparts"),  
  NavigationModel(title: "MMS", icon: Icons.dvr, router: "mms"),
  NavigationModel(title: "TI-Corporativa", icon: Icons.person_pin, router: "ticorporativa"),    
